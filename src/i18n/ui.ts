...
const AR = {
  ...
  theme: {
    ...
    convertOffer: 'الدعوة بالعربي والأسماء مكتوبة بالإنجليزي. تحب نكتبهم بالعربي؟ دوس على الاسم، ولو الإملاء مش مظبوط تقدر تعدله بعدين.',
    convertOfferLatin: 'الدعوة بالإنجليزي والأسماء مكتوبة بالعربي. تحب نكتبهم بالإنجليزي؟ دوس على الاسم وتقدر تعدله بعدين.',
...
const EN: Dictionary = {
  ...
  theme: {
    ...
    convertOffer: 'The invitation is in Arabic and the names are written in English. Want them in Arabic? Tap a name, and you can still edit the spelling afterwards.',
    convertOfferLatin: 'The invitation is in English and the names are written in Arabic. Want them in English? Tap a name, and you can edit the spelling afterwards.',
