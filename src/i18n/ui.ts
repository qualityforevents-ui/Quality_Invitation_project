...
const AR = {
  ...
  flow: {
    ...
    messageTitle: 'كلمة تتكتب على الدعوة',
    messageHint: 'اختار وحدة جاهزة أو اكتب كلامك انت.',
    messageOwn: 'اكتب كلامي',
    messageOwnPlaceholder: 'اكتب الكلمة اللي تحب تظهر على الدعوة',
    messageSkip: 'من غير كلمة',
    messageSummary: 'الكلمة',
  ...
  theme: {
    ...
    noMusic: 'بدون موسيقى',
    noMusicHint: 'تفتح الدعوة في هدوء تام وبدون تشغيل أي صوت.',
    play: 'شغل',
    pause: 'وقف',
    photo: 'صورة العروسين',
    ...
    themeView: 'افتح التصميم ده',
    themeSwipe: 'اسحب تتفرج. اللي في النص هو اللي متختار.',
    themePrev: 'التصميم اللي قبله',
    themeNext: 'التصميم اللي بعده',
...
const EN: Dictionary = {
  ...
  flow: {
    ...
    messageTitle: 'A line for the invitation',
    messageHint: 'Pick one, or write your own.',
    messageOwn: 'Write my own',
    messageOwnPlaceholder: 'The words you want on the invitation',
    messageSkip: 'No line',
    messageSummary: 'Your line',
    messageNone: 'No line',
  ...
  theme: {
    ...
    noMusic: 'No music',
    noMusicHint: 'The invitation opens silently without music.',
    play: 'Play',
    pause: 'Pause',
    ...
    themeView: 'Open this design',
    themeSwipe: 'Swipe to browse. The one in the middle is the one you get.',
    themePrev: 'Previous design',
    themeNext: 'Next design',
